  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
    ...
    if (HttpServletUtil.acceptsJSON(req)) {
      ...
      if (null != pathInfo && "/user".equals(pathInfo)) {
        ...
        result = new JtonObject()
            .set("apiRootUrl", HttpServletUtil.getBaseUrl(req)) // not used
            ...
            .set("context", new JtonObject()
                ...
                .set("stores", new JtonArray()
                    .push("memory")))
            .set("libraries", new JtonArray()
                .push(new JtonObject()
                    .set("id", "local")
                    .set("label", "editor:library.types.local")
                    .set("user", false)
                    .set("icon", "font-awesome/fa-hdd-o"))
                .push(new JtonObject()
                    .set("id", "examples")
                    .set("label", "editor:library.types.examples")
                    .set("user", false)
                    .set("icon", "ffont-awesome/fa-life-ring")
                    .set("types", new JtonArray()
                        .push("flows"))
                    .set("readOnly", true)))
